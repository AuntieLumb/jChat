jChat [![GitHub version](https://img.shields.io/badge/release-v2.3.4-blue)](#) [![GitHub license](https://img.shields.io/github/license/giambaJ/jChat)](https://github.com/giambaJ/jChat/blob/main/LICENSE)
...
### The app is up and running on the website. (link removed)
## Features
